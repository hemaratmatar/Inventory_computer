...
import Prolist from "../Product/product-list";
import login from "../../login.png";
import logo from "../../Pic/logoBanner.png";
        ...
        <Layout>
          ...
          <Content style={{ padding: "0 50px", marginTop: 64 }}>
            <div style={{ background: "#fff", padding: 24, minHeight: 1000 }}>
              <img src={login} className="d-block w-100" />
          ...
          <Footer style={{ textAlign: "center" }}>
            Ant Design ©2018 Created by Hemarat Matar{" "}
          </Footer>
        </Layout>
      );
    }
      ...
      <Layout>
        ...
        >
          ...
          <Menu theme="dark" mode="inline" defaultSelectedKeys={["1"]}>
            ...
            >
              <Menu.Item key="4">
                <Link to="/person-list">Search</Link>
              </Menu.Item>
              <Menu.Item key="5">
            ...
            >
              {/*<Menu.Item key="6"><Link to="/room-list">Room List</Link></Menu.Item>*/}
              <Menu.Item key="7">
          ...
          <Header style={{ background: "#fff", padding: 0 }}>
            <h6 style={{ textAlign: "center" }}>
              <Avatar
                ...
                shape="square"
                icon="user"
                src={fireauth.currentUser.photoURL}
              />
              Welcome {fireauth.currentUser.displayName}! to website Inventory
              Computer 
            </h6>
          </Header>
          <Content style={{ margin: "24px 16px 0" }}>
            <div style={{ padding: 24, background: "#fff", minHeight: 812 }}>
              <Switch>
                ...
                <Route path="/product-list" component={Prolist} />
                {/*Person Group*/}
